...
class CountryCodeController extends Controller
{
    ...
    $countryCodes = $collection->map(function ($country) {
        return [
    ...
    CountryCode::insert($countryCodes->toArray());

    return response()->json(['message' => 'Country codes inserted successfully']);
    ...
    /**
     * @group Country Code Management
     *
     * API to retrieve a list of all country codes.
     *
     * @response 200 {
     *   "success": 1,
     *   "Codes": ["+1", "+44", "+91", "+61", ...]
